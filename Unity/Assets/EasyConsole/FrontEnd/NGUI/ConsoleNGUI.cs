...
class ConsoleNGUI : MonoBehaviour
{
    ...
    void Update()
    {
        if (isOpen)
        {
            ...
            int newObjectPanelScroll = Mathf.Clamp((int)((displayObjects.Length - objectPanelButtonVisibleCount) * (objectPanelScroll.scrollValue)), 0, displayObjects.Length);
            ...
            int newComponentPanelScroll = Mathf.Clamp((int)((displayComponents.Length - componentPanelButtonVisibleCount) * (componentPanelScroll.scrollValue)), 0, displayComponents.Length);
    ...
    private IEnumerator BuildObjectPanel()
    {
        ...
        int scrollValue = Mathf.Clamp((int)((displayObjects.Length - objectPanelButtonVisibleCount) * (objectPanelScroll.scrollValue)), 0, displayObjects.Length);
    ...
    private IEnumerator BuildComponentPanel()
    {
        ...
        int scrollValue = Mathf.Clamp((int)((displayComponents.Length - componentPanelButtonVisibleCount) * (componentPanelScroll.scrollValue)), 0, displayComponents.Length);
    ...
    private IEnumerator BuildMethodPanel()
    {
        ...
        int methodScrollValue = Mathf.Clamp((int)((displayMethods.Length - methodPanelButtonVisibleCount) * (methodPanelScroll.scrollValue)), 0, displayMethods.Length);
